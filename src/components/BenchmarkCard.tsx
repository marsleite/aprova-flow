  ...
  if (!weeklyGoalHours || weeklyHours === 0) {
    return (
      <div className="rounded-xl border border-white/[0.06] bg-[#0f1825] p-5">
        ...
        <p className="text-sm text-slate-600">Comece a estudar para comparar seu progresso com outros concurseiros.</p>
      </div>
    );
  }
    ...
    >
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm text-slate-500">Sua posição</span>
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          <span className="text-sm text-slate-500">Top 25%</span>
          <span className="text-sm text-blue-400">
            {benchmarkData?.percentiles.p75 || 0}h
          </span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-sm text-slate-500">Mediana (50%)</span>
          <span className="text-sm text-yellow-400">
            {benchmarkData?.percentiles.p50 || 0}h
          </span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-sm text-slate-500">Você</span>
