...
- [ ] T017 [US1] Record the post-fix flow-chain smoke for `login -> planner -> dashboard -> engine` in `/Users/marleite/workspace/aprova-flow/specs/002-app-stabilization/validation/core-flow-smoke.md` and register the pass/fail outcome in `/Users/marleite/workspace/aprova-flow/specs/002-app-stabilization/validation/closure-log.md`
