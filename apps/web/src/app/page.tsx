...
export const metadata: Metadata = {
  ...
  description:
    'Rastreie horas líquidas de estudo, visualize progresso por matéria e receba insights de IA. A plataforma mais inteligente para passar em concursos públicos.',
  keywords: [
  ...
  openGraph: {
    title: 'AprovaMind | Estudo Inteligente para Concursos',
    description:
      'Rastreie horas líquidas, visualize progresso por matéria e gere planos de estudo com IA. Comece gratuitamente.',
    type: 'website',
    locale: 'pt_BR',
    siteName: 'AprovaMind',
  },
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300 selection:bg-primary/30 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-12">
            <div className="flex items-center gap-3">
              ...
              <span className="font-medium tracking-tight text-foreground text-lg transition-colors">
          ...
          <div className="flex items-center gap-6">
            <Link
              href="/login"
              className="text-xs font-medium tracking-widest text-muted-foreground uppercase hover:text-foreground transition-colors"
            >
              Entrar
            </Link>
            <Link
              href="/login"
              className="px-6 py-3 text-primary-foreground text-xs font-semibold uppercase tracking-widest transition-all duration-300 shadow-lg bg-primary hover:opacity-90 shadow-primary/20 hover:shadow-primary/40 rounded-sm"
            >
              Começar
            </Link>
          </div>
      ...
      <main className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto px-6 relative">
            <div className="max-w-4xl pt-12">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-xl leading-relaxed mb-10 font-light transition-colors">
                Planeje no Planner, ajuste a semana no Dashboard e execute o dia com contexto real
                no Engine. O AprovaMind conecta a jornada inteira em uma ordem só.
              </p>
              <div className="flex flex-col sm:flex-row items-start gap-6">
                <Link
                  href="/login"
                  className="px-8 py-5 text-primary-foreground text-xs font-semibold uppercase tracking-widest transition-all duration-300 shadow-lg bg-primary hover:opacity-90 shadow-primary/20 hover:shadow-primary/40 flex items-center gap-2"
                >
            ...
            <div className="mt-24 max-w-5xl rounded-lg border border-border bg-card shadow-2xl overflow-hidden shadow-primary/5 transition-all">
              <div className="grid grid-cols-1 md:grid-cols-4 min-h-[400px]">
                <div className="border-r border-border p-6 flex flex-col gap-6 bg-muted/20">
                  ...
                  <div className="flex items-center gap-3 text-sm text-foreground group cursor-pointer transition-colors">
                ...
                <div className="md:col-span-3 p-8 md:p-12 relative flex flex-col">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                    <div className="group relative overflow-hidden bg-card border border-border hover:border-primary/50 transition-all p-6">
                      <span className="text-[10px] font-medium text-muted-foreground uppercase tracking-widest mb-4 block">
                        Média Atual
                      </span>
                      <h3 className="text-3xl font-medium text-foreground tracking-tight transition-colors">
                        82%
                      </h3>
                    </div>
                    <div className="group relative overflow-hidden bg-card border border-border hover:border-primary/50 transition-all p-6">
                  ...
                  <div className="mt-8 flex gap-3 border border-border p-4 bg-muted/10 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed mt-1">
                        Sua retenção em Contratos Administrativos caiu 12%. Sugiro sessão focada hoje.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="group overflow-hidden bg-card border border-border hover:border-border/80 transition-all h-full p-10 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-medium text-foreground tracking-tight mb-4 transition-colors">
                    Tracking Milimétrico
                  </h3>
                  <p className="text-sm text-muted-foreground leading-relaxed font-light transition-colors">
                    Adeus planilhas de excel. Cada segundo da sua sessão abastece o motor analítico
                    e reconstrói seu panorama de estudo nativamente.
                  </p>
                </div>
              </div>
              ...
              <div className="group overflow-hidden bg-card border border-border hover:border-primary/50 transition-all h-full p-10 flex flex-col justify-between relative">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-medium text-foreground tracking-tight mb-4 transition-colors text-glow">
                    Ajuste Fino por IA
                  </h3>
                  <p className="text-sm text-muted-foreground leading-relaxed font-light transition-colors">
                    Se a sua retenção caiu, a IA percebe antes de você e injeta na sua agenda a
                    sessão exata para reverter o quadro do conhecimento.
                  </p>
                </div>
              </div>
              ...
              <div className="group overflow-hidden bg-card border border-border hover:border-border/80 transition-all h-full p-10 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed font-light transition-colors">
                    Gerencie o peso estratégico de cada matéria entre múltiplos editais
                    simultaneamente sem enlouquecer e maximizando aprovações.
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* Social Proof */}
        <section className="border-b border-border py-24 bg-muted/5">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex justify-center items-center gap-4 text-xs font-medium tracking-widest uppercase mb-16 text-muted-foreground">
              <span className="w-8 h-[1px] bg-border"></span>
              Números do Beta
              <span className="w-8 h-[1px] bg-border"></span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="border border-border bg-card p-10 flex flex-col gap-3">
                <div className="flex items-center gap-3 text-primary">
                  <Clock className="w-5 h-5" />
                  <span className="text-xs font-medium uppercase tracking-widest text-muted-foreground">Horas Rastreadas</span>
                </div>
                <p className="text-5xl font-medium tracking-tight text-foreground">1.200+</p>
                <p className="text-xs text-muted-foreground font-light">horas líquidas de estudo registradas pelos beta users</p>
              </div>
              <div className="border border-border bg-card p-10 flex flex-col gap-3">
                <div className="flex items-center gap-3 text-primary">
                  <Users className="w-5 h-5" />
                  <span className="text-xs font-medium uppercase tracking-widest text-muted-foreground">Editais Suportados</span>
                </div>
                <p className="text-5xl font-medium tracking-tight text-foreground">12+</p>
                <p className="text-xs text-muted-foreground font-light">editais importados e configurados via PDF</p>
              </div>
              <div className="border border-border bg-card p-10 flex flex-col gap-3">
                <div className="flex items-center gap-3 text-primary">
                  <FileText className="w-5 h-5" />
                  <span className="text-xs font-medium uppercase tracking-widest text-muted-foreground">Sessões Registradas</span>
                </div>
                <p className="text-5xl font-medium tracking-tight text-foreground">5.000+</p>
                <p className="text-xs text-muted-foreground font-light">sessões de estudo rastreadas com horas líquidas</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-32 bg-background border-b border-border">
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-muted-foreground font-light mb-12">
              Abandone a ilusão de cobrir 100% de materiais gigantes. Mude para um planejamento
              cirúrgico e adaptativo guiado por resultados reais.
            </p>
            <Link
              href="/login"
              className="inline-flex px-10 py-5 text-primary-foreground text-xs font-semibold uppercase tracking-widest transition-all duration-300 shadow-lg bg-primary hover:opacity-90 shadow-primary/20 hover:shadow-primary/40 items-center justify-center gap-3"
            >
