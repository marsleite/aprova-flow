...
async function handler(req, res) {
  ...
  if (!body || body.task !== "parse-edital" || typeof body.pdfBase64 !== "string" || typeof body.prompt !== "string") {
    sendJson(res, 400, {
      error: "bad_request",
      message: "Campos obrigat\xF3rios: task (parse-edital), pdfBase64, prompt."
    });
    return;
  }
  try {
    ...
    const result = await gateway.runAiPdf(body);
