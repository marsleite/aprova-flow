...
| DOC-04 | doc | `/Users/marleite/workspace/aprova-flow/docs/product/entitlements-matrix.md` | high | Defines the intended `free -> pro` ladder and server-side authorization expectations. | Strong source for commercial packaging and gating expectations. |
...
| CODE-05 | code | `/Users/marleite/workspace/aprova-flow/apps/web/src/app/(app)/caderno-erros/page.tsx` | high | Shows pro gating, transparency of diagnosis sample, and query strategy. | Key source for performance and product maturity analysis. |
