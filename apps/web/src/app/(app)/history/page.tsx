  ...
  return (
    <div className="flex flex-col gap-8 pb-10">
      ...
      <div className="px-6 space-y-6">
        {/* Heatmap */}
        <motion.div custom={0} variants={fadeUp} initial="hidden" animate="show" className="rounded-xl border border-border bg-card shadow-am-sm overflow-hidden p-6">
        ...
        {/* Full history */}
        <motion.div custom={1} variants={fadeUp} initial="hidden" animate="show" className="rounded-xl border border-border bg-card shadow-am-sm overflow-hidden p-6">
          <h3 className="font-sans text-am-body font-bold text-foreground mb-4 flex items-center gap-2">
            <span className="w-2 h-6 bg-primary rounded-full"></span>
            Listagem Bruta
          </h3>
