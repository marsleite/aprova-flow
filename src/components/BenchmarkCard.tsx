    ...
    return (
      <div className="rounded-xl border border-gray-800 bg-gray-900/50 p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-lg font-semibold text-white">Benchmark Anônimo</h3>
        </div>
        <p className="text-gray-400 text-sm">
          Comece a estudar para comparar seu progresso com outros concurseiros.
        </p>
      </div>
    );
  }
    ...
    >
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm text-gray-400">Sua posição</span>
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          <span className="text-sm text-gray-400">Top 25%</span>
          <span className="text-sm text-blue-400">
            {benchmarkData?.percentiles.p75 || 0}h
          </span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-sm text-gray-400">Mediana (50%)</span>
      ...
      {percentile >= 75 && (
        <motion.div
          ...
          className="mt-4 flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-violet-600/20 to-blue-600/20 rounded-lg border border-violet-600/30"
        >
