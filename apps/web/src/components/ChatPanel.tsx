          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-border px-4 py-3">
              <div className="flex items-center gap-3">
                <div className="rounded-lg bg-gradient-to-br from-primary/20/30 to-primary/20/20 p-2">
              ...
              <div className="flex items-center gap-1">
                {messages.length > 0 && (
                  <button
                    onClick={clearChat}
                    className="rounded-lg p-2 text-muted-foreground transition hover:bg-card hover:text-gray-300"
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4">
              <div className="space-y-4">
                ...
                {loading && (
                  ...
                  >
                    <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[var(--primary)]/20">
                      <Brain className="h-3.5 w-3.5 text-[var(--primary)]" />
                    </div>
                ...
                <div className="mt-6 flex flex-wrap justify-center gap-2">
                  {getSuggestions().map((s) => (
                    <button
                      ...
                      className="rounded-full border border-border bg-muted px-3 py-1.5 text-xs text-muted-foreground transition hover:border-primary/30 hover:text-primary"
                    >
                      {s}
                    </button>
                  ))}
            ...
            <div className="border-t border-border px-4 pb-[calc(0.75rem+env(safe-area-inset-bottom))] pt-3">
              <div className="flex items-center gap-2">
                <input
                  ...
                  disabled={loading}
                  className="flex-1 rounded-xl border border-border bg-card px-4 py-2.5 text-sm text-foreground placeholder-gray-600 outline-none transition focus:border-primary disabled:opacity-50"
                />
                <button
                  onClick={() => sendMessage(input)}
                  disabled={!input.trim() || loading}
                  className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary text-foreground transition hover:bg-primary disabled:opacity-30"
                >
